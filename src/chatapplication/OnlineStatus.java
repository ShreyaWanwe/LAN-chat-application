...
if(!al.contains(name)&& !name.equals("exited"))
{
   ...
   if(MulticastClient.onlineTextArea.getText().equals(""))
     MulticastClient.onlineTextArea.setText(name);
   else
   { MulticastClient.onlineTextArea.setText("");
   for(Object obj:al)
   {
     MulticastClient.onlineTextArea.setText(MulticastClient.onlineTextArea.getText()+obj.toString()+"\n");  
   }
   }       
}
